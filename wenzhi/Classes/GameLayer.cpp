...
void GameLayer::updateHero(float dt)
{
	if (_hero->getCurrentState() == ACTION_STATE_WALK)
	{
		...
		switch (_hero->getDir())
		{
		case DIR_RIGHT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y); break;
		case DIR_UPRIGHT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y + 0.8); break;
		case DIR_DOWNRIGHT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y - 0.8); break;
		case DIR_LEFT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y); break;
		case DIR_UPLEFT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y + 0.8); break;
		case DIR_DOWNLEFT: endPosition = Vec2(_hero->getPosition().x + _hero->getSpeed(), _hero->getPosition().y - 0.8); break;
		...
		{
			this->setPositionX(this->getPositionX() - _hero->getSpeed());
		}
